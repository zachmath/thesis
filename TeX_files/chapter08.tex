...
\begin{figure}%
	...
	\qquad
	\subfloat[$^{240}$Pu proton localization function]{{\includegraphics[width=0.455\linewidth]{TeX_files/frags_240Pu_proton} }}%
...
\begin{figure}%
	\centering
	\subfloat[$^{240}$Pu PES]{{\includegraphics[width=0.9\linewidth]{TeX_files/frags_240Pu-PES} }}%
	\qquad
	\subfloat[$^{240}$Pu yield]{{\includegraphics[width=0.7\linewidth]{TeX_files/frags_240Pu-yield} }}%
...
\begin{figure}%
	\centering
	\subfloat[$^{294}$Og PES]{{\includegraphics[width=0.9\linewidth]{TeX_files/frags_294Og-PES} }}%
	\qquad
	\subfloat[$^{294}$Og yield]{{\includegraphics[width=0.7\linewidth]{TeX_files/frags_294Og-yield} }}%
