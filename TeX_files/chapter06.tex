...
\begin{figure}%
	\centering
	\subfloat[$^{254}$Pu PES]{{\includegraphics[width=0.9\linewidth]{TeX_files/rproc_254Pu-PES} }}%
	\qquad
	\subfloat[$^{254}$Pu yield]{{\includegraphics[width=0.7\linewidth]{TeX_files/rproc_254Pu-yield} }}%
...
\begin{figure}%
	\centering
	\subfloat[$^{290}$Fm PES]{{\includegraphics[width=0.9\linewidth]{TeX_files/rproc_290Fm-PES} }}%
	\qquad
	\subfloat[$^{290}$Fm yield]{{\includegraphics[width=0.7\linewidth]{TeX_files/rproc_290Fm-yield} }}%
