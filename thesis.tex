...
\title{Fission in Exotic Nuclei Using DFT} %% Put the title of your dissertation here.
...
\include{./TeX_files/chapter06} % Outlook
...
\appendix
%\appendices
\include{./TeX_files/chapter07} % Appendix A: Temperature-dependence of collective inertia
...
%% preamble and here.
\bibliography{main}
\bibliographystyle{abbrv} % I don't know what bibliography style to use, so this is a placeholder
